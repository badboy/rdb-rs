...
pub trait RdbParseFormatter {
    ...
    fn start_hash(&mut self, key: &[u8], length: u32, expiry: Option<u64>, info: Option<()>) {}
    fn end_hash(&mut self, key: &[u8]) {}
    fn hash_element(&mut self, key: &[u8], field: &[u8], value: &[u8]) {}


    fn start_set(&mut self, key: &[u8], cardinality: u32, expiry: Option<u64>, info: Option<()>) {}
    ...
    fn start_sorted_set(&mut self, key: &[u8], length: u32, expiry: Option<u64>, info: Option<()>) {}
